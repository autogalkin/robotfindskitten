...
public:
  ...
  using scroll_changed_signal = boost::signals2::signal<void(const position_t &)>;
  ...
  [[nodiscard]] uint8_t get_char_width() const noexcept {
    return static_cast<uint8_t>(
        dcall2(SCI_TEXTWIDTH, STYLE_DEFAULT, reinterpret_cast<sptr_t>(" ")));
  }
  // pixels
...
protected:
  HWND create_native_window(DWORD dwExStyle, LPCWSTR lpWindowName,
                            ...
                            HINSTANCE hInstance, LPVOID lpParam, uint8_t start_options);
