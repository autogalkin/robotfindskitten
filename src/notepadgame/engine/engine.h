...
protected:
    ...
    npi_t dcall0(const int message) const                                   { return direct_function_(direct_wnd_ptr_, message, 0, 0);}  // NOLINT(modernize-use-nodiscard)
    npi_t dcall1(const int message, const uptr_t w) const                   { return direct_function_(direct_wnd_ptr_, message, w, 0);}  // NOLINT(modernize-use-nodiscard)
    npi_t dcall1_l(const int message, const sptr_t l) const                 { return direct_function_(direct_wnd_ptr_, message, 0, l);}  // NOLINT(modernize-use-nodiscard)
    npi_t dcall2(const int message, const uptr_t w, const sptr_t l) const   { return direct_function_(direct_wnd_ptr_, message, w, l);}  // NOLINT(modernize-use-nodiscard)
...
inline void engine::force_set_background_color(const COLORREF c) const noexcept
{
